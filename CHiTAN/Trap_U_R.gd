...
@export var move_distance_up: float = 50.0     # Khoảng cách di chuyển lên
@export var move_distance_right: float = 190.0  # Khoảng cách di chuyển sang phải
@export var move_speed: float = 40           # Tốc độ di chuyển
